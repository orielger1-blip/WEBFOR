        ...
        >
          ...
          >
            ...
            <div className="contact-methods">
              <a href="https://wa.me/972525590062" className="contact-method" target="_blank" rel="noopener noreferrer">
              ...
              <a href="mailto:i@alter1.com" className="contact-method">
                <div className="contact-method-icon">
                ...
                <div className="contact-method-text">
                  <h4>אימייל</h4>
                  <span>i@alter1.com</span>
                </div>
              </a>

              <a href="tel:+972525590062" className="contact-method">
                <div className="contact-method-icon">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
