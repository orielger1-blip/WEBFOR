...
const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    description: 'אוריאל הוא בוגר יחידה טכנולוגית מובחרת בצה"ל, עם רקע מעמיק בפיתוח מערכות מורכבות. מוביל את החזון הטכנולוגי של Agentive ואחראי על ארכיטקטורת המוצר והצוות הטכני.',
